...
* **Part 1: [Vector Space Model](#vsm)** *(50 points)*: get the basic idea of text processing, e.g., tokenization, stemming, and normalization, constructing vector space representation for text documents, TF/IDF calculation, and compute similarity among different text documents;
* **Part 2: [Language Models](#slm)** *(50 points)*: get the basic idea of statistic language models, including maximum likelihood estimator, smoothing, generate text from language models, and language model evaluation.
...
## Pre-processing
There are several steps of pre-processing you need to take in this assignment.
