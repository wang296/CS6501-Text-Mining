...
# <a name="part1"></a>Part1: Vector Space Model       

There are several steps you need to take in this part of assignment.

1. Tokenization: tokenize the review content each document into tokens.
...
1. For each token, go over all the review documents containing it and accumulate its frequency in those documents, i.e., total term frequency.
